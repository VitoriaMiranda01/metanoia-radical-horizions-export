...
import { exportAcampantesToExcel } from '@/lib/acampanteHelpers';
  ...
  return (
    <div className="flex items-center h-full">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start" className="w-56 bg-slate-950 border-white/20 max-h-80 overflow-y-auto z-50 p-1 shadow-xl">
      ...
      <CardHeader className="p-4 md:p-6">
          ...
          <div className="flex flex-col md:flex-row md:flex-wrap items-stretch md:items-center gap-1 md:gap-2 w-full md:w-auto">
              {hasActiveFilters && (
                  <Button 
                    ...
                    className="text-red-400 hover:text-red-300 hover:bg-red-500/10 border border-red-500/20 text-xs md:text-sm h-8 md:h-9"
                  >
              ...
              <div className="hidden md:contents">
                ...
                <Button 
                  ...
                  className="bg-white/5 text-white hover:bg-white/10 border-white/20 text-xs md:text-sm h-8 md:h-9"
                >
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 mt-2 md:mt-4">
          <div className="relative flex-1">
            ...
            <Input
              type="text"
              placeholder="Buscar por nome, CPF, igreja, admin..."
              value={searchTerm}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-slate-900 border-white/20 text-white">
                ...
                <div key={item.id} className="bg-white/5 border border-white/10 rounded-lg overflow-hidden flex flex-col">
                  ...
                  <div className="bg-black/20 p-3 flex gap-2 border-t border-white/10">
                    ...
                    <Button 
                      ...
                      className="flex-1 h-11 bg-transparent border-white/20 text-red-400 hover:text-red-300 hover:bg-red-500/10"
                    >
              ...
              <Table>
                <TableHeader className="bg-white/5">
                  <TableRow className="hover:bg-transparent border-white/10">
                    <TableHead className="text-white md:sticky md:left-0 md:z-20 min-w-[140px] md:min-w-[200px] bg-slate-950 md:border-r md:border-white/10 md:shadow-[2px_0_5px_-2px_rgba(0,0,0,0.5)] p-2 md:p-4">
                      <ColumnHeader 
                        title="Nome" 
                        filterKey="nome" 
                        filters={filters} 
                    ...
                    {visibleColumns.map(colKey => {
                      ...
                      const def = getColDef(colKey);
                      return (
                        <TableHead key={colKey} className="text-white whitespace-nowrap min-w-[120px] md:min-w-[150px] bg-slate-950/50 p-2 md:p-4">
                          <ColumnHeader 
                    ...
                    <TableHead className="text-right text-white sticky right-0 z-20 bg-slate-950 border-l border-white/10 shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.5)] p-2 md:p-4 text-xs md:text-sm">
                      Ações
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredData.map((item) => (
                    <TableRow key={item.id} className="hover:bg-white/5 border-white/10 transition-colors group">
                      <TableCell className="font-medium text-white md:sticky md:left-0 md:z-10 bg-slate-950 group-hover:bg-slate-900 md:border-r md:border-white/10 md:shadow-[2px_0_5px_-2px_rgba(0,0,0,0.5)] p-2 md:p-4 text-xs md:text-sm">
                        {item.nome}
                      </TableCell>
                      ...
                      <TableCell className="text-right sticky right-0 z-10 bg-slate-950 group-hover:bg-slate-900 border-l border-white/10 shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.5)] p-2 md:p-4">
