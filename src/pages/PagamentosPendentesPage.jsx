...
import { fetchAcampantesPendentesPagamento, fetchEquipantesPendentesPagamento, confirmarPagamentoManual } from '@/services/paymentService';
...
const PagamentosPendentesPage = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      } = await fetchAcampantesPendentesPagamento();
      ...
      } = await fetchEquipantesPendentesPagamento();
      ...
      toast({
        title: 'Erro',
        description: 'Não foi possível carregar as inscrições com pagamento manual ou isento.',
        variant: 'destructive'
      });
    } finally {
      setLoading(false);
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        y: 0
          ...
          <p className="text-gray-400">
            Gerencie e confirme os pagamentos manuais.
          </p>
        </motion.div>
        ...
        y: 0
            ...
            <div className="p-4 md:p-6 border-b border-white/10 flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
              ...
              <div className="relative w-full md:w-72">
                ...
                <Input placeholder="Buscar por CPF, Nome..." value={filterText} onChange={e => setFilterText(e.target.value)} className="pl-9 h-11 bg-white/5 border-white/10 text-white w-full placeholder:text-gray-500 focus-visible:ring-blue-500" />
              </div>
            </div>
            ...
            <div className="md:hidden flex flex-col gap-4 p-4">
              {loading ? <div className="text-center text-gray-400 py-8">
                  ...
                  Nenhuma inscrição com pagamento manual ou isento encontrada.
              ...
              <Table>
                ...
                <TableBody>
                  {loading ? <TableRow className="border-white/10 hover:bg-transparent">
                      ...
                      <TableCell colSpan={6} className="h-32 text-center text-gray-400">
                        Nenhuma inscrição com pagamento manual ou isento encontrada para os filtros atuais.
                      </TableCell>
