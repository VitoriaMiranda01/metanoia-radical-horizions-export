...
const Statistics = ({ equipantes, acampantes, total }) => {
  const stats = [
    { label: 'Equipantes', count: equipantes, icon: Users, color: 'blue' },
    { label: 'Acampantes', count: acampantes, icon: UserCheck, color: 'purple' },
    { label: 'Total de Inscrições', count: total, icon: UserCheck, color: 'green' },
  ];
