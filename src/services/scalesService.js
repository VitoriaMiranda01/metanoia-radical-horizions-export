...
const COLUNAS_EQUIPANTE =
  'id, nome, whatsapp, sexo, igreja, igreja_outra, nacionalidade, area_trabalho_opcao1, area_trabalho_opcao2, area_trabalho_opcao3, numero_edicao, status, status_pagamento, cpf';
