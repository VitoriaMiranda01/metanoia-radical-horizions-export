...
import { CreditCard, CheckCircle2, Info, ArrowLeft, ExternalLink, Tag, Loader2 } from 'lucide-react';
...
const ManualPaymentPage = () => {
  ...
  const { value: baseInscriptionValue, loading: loadingValue } = useEquipanteInscriptionValue();
  ...
  const nome = location.state?.nome_completo || location.state?.nome || 'Participante';
              ...
              <div className="bg-white/5 p-5 rounded-xl border border-white/10 text-left space-y-4 max-w-sm mx-auto">
                ...
                <div className="flex gap-2">
                  <Input 
                    ...
                    disabled={appliedCoupon !== null || isFinalizingZero} 
                  />
                  {appliedCoupon ? (
                    <Button 
                      variant="outline" 
                    ...
                    <Button 
                      ...
                      disabled={!couponInput || validatingCoupon || isFinalizingZero} 
