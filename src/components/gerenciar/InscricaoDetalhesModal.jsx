...
const InscricaoDetalhesModal = ({ inscricao, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-slate-900 border border-white/10 rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex justify-between items-center p-6 border-b border-white/10 bg-slate-800/50">
          <h3 className="text-xl md:text-2xl font-bold text-white">Detalhes da Inscrição - Equipante</h3>
          <Button 
            variant="ghost" 
            size="sm"
            onClick={onClose}
        ...
        <div className="overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="bg-white/5 p-3 rounded-md">
                <span className="text-sm text-gray-400 block mb-1">Nome Completo:</span>
                <p className="text-white font-medium">{displayValue(inscricao.full_name || inscricao.nome_completo || inscricao.nome)}</p>
              </div>
              <div className="bg-white/5 p-3 rounded-md">
              ...
              <div className="bg-white/5 p-3 rounded-md">
                ...
                <p className="text-white font-medium">{displayValue(inscricao.sexo || inscricao.genero)}</p>
              </div>
              <div className="bg-white/5 p-3 rounded-md">
              ...
              <div className="bg-white/5 p-3 rounded-md">
                ...
                <p className="text-white font-medium">{displayValue(inscricao.tamanho_camisa || inscricao.tamanho_camiseta || inscricao.camisa)}</p>
              </div>
              <div className="bg-white/5 p-3 rounded-md">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="bg-white/5 p-3 rounded-md">
                <span className="text-sm text-gray-400 block mb-1">Nosso Número Boleto:</span>
                <p className="text-white font-medium">{displayValue(inscricao.nosso_numero_boleto)}</p>
              </div>
              <div className="bg-white/5 p-3 rounded-md">
                <span className="text-sm text-gray-400 block mb-1">Código de Barras Boleto:</span>
                <p className="text-white font-medium">{displayValue(inscricao.codigo_barras_boleto)}</p>
              </div>
              <div className="bg-white/5 p-3 rounded-md">
                <span className="text-sm text-gray-400 block mb-1">Data Vencimento Boleto:</span>
                <p className="text-white font-medium">{formatarDataSimples(inscricao.data_vencimento_boleto)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="bg-white/5 p-3 rounded-md">
                <span className="text-sm text-gray-400 block mb-1">User ID:</span>
                <p className="text-white font-medium text-xs break-all">{displayValue(inscricao.user_id)}</p>
              </div>
              <div className="bg-white/5 p-3 rounded-md">
                <span className="text-sm text-gray-400 block mb-1">ID:</span>
                <p className="text-white font-medium text-xs break-all">{displayValue(inscricao.id)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-4 border-t border-white/10">
            ...
            <div className="bg-white/5 p-3 rounded-md">
              <span className="text-sm text-gray-400 block mb-1">Data de Inscrição:</span>
              <p className="text-white font-medium">{formatarData(inscricao.created_at)}</p>
            </div>
            <div className="bg-white/5 p-3 rounded-md">
              <span className="text-sm text-gray-400 block mb-1">Última Atualização:</span>
              <p className="text-white font-medium">{formatarData(inscricao.updated_at)}</p>
            </div>
          </div>
        </div>
      </div>
