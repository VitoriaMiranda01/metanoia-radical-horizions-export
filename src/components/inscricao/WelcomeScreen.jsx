...
const formatCurrency = (value) => {
  if (value === null || value === undefined || isNaN(value)) return "Não configurado";
...
const WelcomeScreen = ({
  ...
  const { currentPrice, loading: priceLoading, error: priceError } = useCurrentPrice();
                  ...
                  {isFullyLoading ? (
                    ...
                    <>
                      ...
                      <p className="font-semibold text-green-500">
                        Investimento: {priceError ? 'Não configurado' : (currentPrice !== null ? formatCurrency(currentPrice) : 'Não configurado')} (alimentação, transporte e camisa inclusos)
                      </p>
                    </>
                  )}
                </div>
