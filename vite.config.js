...
import inlineEditPlugin from './dev-tools/plugins/visual-editor/vite-plugin-react-inline-editor.js';
import editModeDevPlugin from './dev-tools/plugins/visual-editor/vite-plugin-edit-mode.js';
import iframeRouteRestorationPlugin from './dev-tools/plugins/vite-plugin-iframe-route-restoration.js';
import selectionModePlugin from './dev-tools/plugins/selection-mode/vite-plugin-selection-mode.js';
import sitePagesPlugin from './dev-tools/plugins/vite-plugin-site-pages.js';
